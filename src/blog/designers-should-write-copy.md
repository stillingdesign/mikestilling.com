---json
{
    ...
    "headline": "Designers should <span class='sm:space:nowrap'>write <span class='space:nowrap'>copy vs. code</span></span>",
    "subhead": "Wouldn't it make sense to write <span class='space:nowrap'>the words that we're designing?</span>",
