...
ogDescription: "See how Mike designed and built everything marketing related for Rewatch"
...
For the final touches, Mike looked toward the product for direction. Thankfully, Rewatch's product design team is top notch <span class="opacity:70">(shoutout to</span> [Conor Muirhead](https://www.conor.cc/)<span class="opacity:70">, who was also Mike's manager).</span> To increase uniformity, the primary color, grayscale, button stylings, and font-family were pulled from <span class="space:nowrap">the product.</span>
